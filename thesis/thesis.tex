...
\iffalse
	W tej pracy opisujemy różne metody tworzenia agentów grających w grę kooperacyjną Hanabi z ograniczonym czasem na pojedyncze ruchy, w celu utworzenia programu zdolnego do gry na poziomie człowieka.
	W tym celu stworzyliśmy 7 różnych agentów regułowych o różnym stopniu zaawansowania oraz jednego agenta uczącego się grać samoistnie i następnie zbadaliśmy ich osiągi w różnych wariancjach partii gry. Sprawdziliśmy również jak zachowują się w zależności między sobą, nie mając wiedzy o wykorzystywanych wzajemnie strategiach.
	Testy wykazały, że nasi najlepsi agenci potrafią grać na poziomie podobnym do ludzkiego bez konieczności poświęcania dużej ilości czasu na obliczenia w trakcie tury. Pokazaliśmy również skuteczność metod uczących, gdzie korzystając z naszego modelu agent wypracował samemu strategię zdobywającą wyniki zbliżonych do wyników osiąganych przez ludzkich graczy.
	Ta praca stawia podwaliny pod dalsze rozwinięcia problematyki wysokopoziomowej rozgrywki w grę Hanabi z ograniczonym czasem i stanowi dowód konceptu.
\fi
