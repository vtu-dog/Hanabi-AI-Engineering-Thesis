...
\begin{itemize}
	...
	\item czy zagrywanie podpowiadanych kart od~lewej do~prawej byłoby bezpieczne,
...
Najlepsze średnie wyniki agentów, którzy nie~oszukują, oscylują pomiędzy 19.07 punktów w~rozgrywkach dwuosobowych a~20.83 punktów w~rozgrywkach czteroosobowych, co, według instrukcji (patrz: \hyperref[fig:scores]{\textbf{Rysunek 2.2}}), jest dobrym rezultatem. Uważamy~się za~wprawnych graczy --~osiągi najbardziej zaawansowanych agentów pokrywają~się z~naszymi.
...
Agenci nie~osiągają zaprezentowanych przez badaczy z~Google'a i~Facebooka wyników rzędu 24.5 punktów, lecz ich ruchy są~wykonywane niemal natychmiastowo, co~pozwala na~komfortową rozgrywkę z~człowiekiem na~komputerach osobistych.
...
\begin{table}[H]
	...
	\begin{tabular}{ r|c|c| }	
 		\multicolumn{1}{r}{}	
 		 & \multicolumn{1}{c}{Wojciech Jarząbek}		
 		 & \multicolumn{1}{c}{Jacek Leja} \\		
 		\cline{2-3}
 		Szkielet programu & **** & ** \\
 		\cline{2-3}
 		...
 		Koncepcje agentów & ** & ***** \\
 		\cline{2-3}
 		Tworzenie agenta Cheater & ***** & * \\
 		\cline{2-3}
 		Tworzenie agenta SmartCheater & ** & **** \\
 		\cline{2-3}
 		Tworzenie agenta Erratic & ** & **** \\
 		\cline{2-3}
 		Tworzenie agenta StoppedClock & *** & *** \\
 		\cline{2-3}
 		Tworzenie agenta SimpleDistrustful & ** & **** \\
 		\cline{2-3}
 		Tworzenie agenta Distrustful & * & ***** \\
 		\cline{2-3}
 		Tworzenie agenta Trustful & * & ***** \\
 		\cline{2-3}
 		Tworzenie agentów BayesianTrustful & *** & *** \\
 		\cline{2-3}
 		Tworzenie agentów Reinforced & * & ***** \\
 		\cline{2-3}
 		Testy poprawnościowe i wydajnościowe & *** & *** \\
 		\cline{2-3}
 		Dostrajanie parametrów agentów & ** & **** \\
 		\cline{2-3}
 	\end{tabular}		
 	\caption{Tworzenie aplikacji}		
 \end{table}
