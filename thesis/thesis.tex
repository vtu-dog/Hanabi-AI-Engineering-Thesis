...
\begin{table}[H]
 ...
 Agent BayesianTrustful uzyskał aż~trzy z~czterech najwyższych średnich punktów spośród agentów, którzy nie~oszukują. Lepszym wyborem do~partii na trzech graczy byłby jednak agent Trustful -~choć jego wynik jest nieco niższy, różnica w~odchyleniu standardowym jest na~tyle znacząca, by~móc chcieć go~wybrać ponad BayesianTrustful w~celu uzyskania bardziej stabilnego przebiegu rozgrywki.
